...
import { faUser, faTrophy, faEnvelope, faLightbulb, faCode, faDesktop, faStarHalfAlt, faGraduationCap } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <NavWrapper>
      ...
      {location.pathname !== '/achievements' && (
        <Link to="/achievements"><NavButton><FontAwesomeIcon icon={faTrophy} /> Achievements</NavButton></Link>
      )}
